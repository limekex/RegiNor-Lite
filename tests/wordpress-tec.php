...
$oldDateFormat = tribe_get_option('datepickerFormat'); $writeMode = 'no_write';
...
try {
    ...
    $assert(str_contains(TecBridge::status($period), 'databaselåsen'), 'Låsefeil forveksles med fremtidig kursstart.');
    TecBridge::sync();
    ...
    wp_set_current_user($admin); $draft($period);
